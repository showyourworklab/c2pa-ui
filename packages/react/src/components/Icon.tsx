...
import { BadgeInfo, Camera, Check, Ellipsis, SquarePen, Sparkles, ImageOff, X, ChevronDown, ChevronUp, TriangleAlert, CircleAlert } from 'lucide-react'
...
export const ICONS: Record<IconType, typeof BadgeInfo> = {
	...
	down: ChevronDown,
	close: X,
	"alert-ai": TriangleAlert,
	"alert-noai": CircleAlert,
}
