...
export const DICTIONARY_SV_SE = {
	...
	explainer_section_1_body: 'Information om hur, när och var bilden togs, och vilka ändringar som gjorts därefter, kryptografiskt säkras i varje steg. Detta görs med hjälp av <a href="https://c2pa.org/" target="_blank">C2PA</a>, en ny teknisk standard som gör det möjligt att dokumentera en bilds ursprung och historia. Det innebär att varken bilden eller informationen om den kan ändras eller tas bort utan att lämna spår.',
	explainer_section_2_title: 'Hur man använder detta',
	explainer_section_2_body: 'Välj <strong>Se bildens ursprung</strong> för att se en steg-för-steg-översikt över bildens historik. För varje steg kan du se när det ägde rum, vilken kamera, enhet eller programvara som användes och hur informationen kryptografiskt signerades. På fliken <strong>Bild</strong> kan du se hur bilden såg ut vid varje steg. Om informationen är tillgänglig kan du också använda flikarna <strong>Karta</strong> för att se var bilden togs och flikarna <strong>Redigera</strong> för att se vilka ändringar som har gjorts.',
	explainer_footer: 'Not all images carry this information, and not every step includes every detail. An incomplete record doesn\'t necessarily mean a file is fake, only that this information wasn\'t captured or made available.',
	// Statuses
